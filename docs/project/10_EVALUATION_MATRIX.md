...
| Efficiency | 10+ drones, complex graphs, reasonable compute | M5-B benchmark runner and official suite baseline | EVIDENCED |
| Explanation | Complexity, design, capacity/optimization trade-offs | README + defense notes | NOT_STARTED |
| Easy benchmarks | Category <10; targets 6/8/6 with 2/4/4 drones | M5-B: 4/4/4 turns, validator-clean | EVIDENCED |
| Medium benchmarks | 10-30; targets 12/15/12 with 5/6/5 | M5-B: 8/10/6 turns, validator-clean | EVIDENCED |
| Hard benchmarks | <60; targets 30/35/45 with 8/12/15 | M5-B: 13/16/26 turns, validator-clean | EVIDENCED |
...
| Bonus performance | Meet/beat every individual target | M5-B official suite table | EVIDENCED |
| Challenger | Beat 45 turns, meaning <=44 | M5-B valid schedule is 43 turns | EVIDENCED |
